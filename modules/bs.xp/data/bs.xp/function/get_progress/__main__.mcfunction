...
data modify storage bs.xp:get_progress out set compute default float {type:div,left:{type:storage,storage:"bs.xp:",path:"points"},right:{type:number_dispatcher,cases:[ \
