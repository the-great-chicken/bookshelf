...
return run execute store result storage bs.xp:get_remaining_points out int 1 run compute default integer {type:sub,right:{type:storage,storage:"bs.xp:",path:"points"},left:{type:number_dispatcher,cases:[ \
