...
$data modify storage bs.xp: points set compute default integer {type:max,inputs:[0,{type:min,inputs:[1000000000,{type:add,inputs:[{type:"from_float",input:{type:mul,inputs:[$(progress),1000000000]}},{type:storage,storage:"bs.xp:",path:"points"}]}]}]}
